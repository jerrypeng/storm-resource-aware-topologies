...
public class DiamondTopology {
	public static void main(String[] args) throws Exception {
       ...
       BoltDeclarer bolt1 = builder.setBolt("bolt_1", new TestBolt(), paralellism+2);
       BoltDeclarer bolt2 = builder.setBolt("bolt_2", new TestBolt(), paralellism+2);
       BoltDeclarer bolt3 = builder.setBolt("bolt_3", new TestBolt(), paralellism+2);
       BoltDeclarer bolt4 = builder.setBolt("bolt_4", new TestBolt(), paralellism+2);
